 ...
 *
 * 그래서 이 파일이 그 화면들을 하나로 잇습니다. 새로 만든 것은 잇는 일뿐입니다. 각
 ...
 * 열어 같은 안내를 다시 보여 줄 이유가 없습니다.
 *
 * 영상은 스토리보드 걸음 안에 있습니다 — 승인된 컷의 「영상으로 생성」이 그 일입니다. 다만
 * 예시는 그 단추를 짚어 주고 끝냅니다. 실제로 누르면 GPU 가 한 컷에 30초~4분을 쓰고,
 * 기다리는 것을 안내라고 부를 수 없습니다.
 *
 * 걸음이 몇이라는 것은 홈의 단계 목록이 말하고, 여기서는 걷는 길만 정합니다. 그래서
 * 홈의 문구는 이 길이의 값(DEMO_TOTAL)을 받아서 적습니다 — 두 수가 어긋나면 안 됩니다.
 */
